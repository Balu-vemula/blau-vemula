...
describe("Verifying the functionality of Growth Rate By Accounts KPI", () => {
    ...
    context("Verifying the functionality of Tile view of the Growth Rate By Accounts KPI", () => {
        RoleFilter(['smoke', 'regression'], () => {
		...
		RoleFilter(['smoke', 'regression'], () => {
			it('Verifying the title of the KPI', () => {
				robotHands.scrollingIntoGrowthRateTile()
				robotEyes.seesTitleOfGrowthRateByAccounts()
				robotEyes.verifyingTheTitleOfGrowthRateKPIWithDefaultDatePickerFrequency()
			})
			it('Verifying the graph and the value of the Growth Rate By Accounts on the tile view', () => {
				robotHands.scrollingIntoGrowthRateTile()
				robotHands.clickOnMembershipIcon()
			...
			it('Verifying the functionality of the date picker on the tile view', () => {
				...
				robotHands.scrollingIntoGrowthRateTileAfterChangingTheFrequencyFromDefault() 
				robotEyes.veryfingTheTitleOfGrowthRateTileViewAfterChangingTheFrequencyFromDefault()
			})
        })
    })
    context('Verifying the functionality of drill down view of Growth Rate By Accounts', () => {
        RoleFilter(['smoke','regression'],() => {
			it('Verifying the Growth Rate By Accounts drill-down view', () => {
				robotHands.clickOnMonthlyGrowthRateTile() 
				robotEyes.seesBacktoMembershipVisibleOnDrillDownView()
				robotEyes.seesTopNavigationBarIsVisibleOnDrillDownView()
				robotEyes.seesDatePickerIsVisibleOnDrillDownViewOnGrowthRateDrilldownView()
				...
				robotEyes.seesGraphOnGrowthRateDrillDownView()
		...
		RoleFilter(['regression'], () => {
			it('Verifying the context of Table', () => {	
				...
				robotHands.clickOnDatePickerInGrowthRateDrillDownView()
