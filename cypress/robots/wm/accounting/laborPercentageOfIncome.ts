...
export class RobotEyes extends BaseEyes {
	...
	seesDatePickerIsVisibleOnDrillDownView() {
		this.wait(3000)
		this.seesDomVisible('button[aria-describedby="LABOR_PERCENTAGE_OF_INCOME"]')
	}
	...
	seesGraphOnDrillDownView() {
		this.wait(3000)
		this.seesIdVisible('drill-down-LABOR_PERCENTAGE_OF_INCOME')
	...
	seesTheSortButtonsForLaborPercentageOfIncome() {
	...
	verifyTheCancelButtonInTheLocationInDrillDownViewForLaborPercentageOfIncome() {
	...
	verifyTheApplyButtonInTheLocationInDrillDownViewForLaborPercentageOfIncome() {
		this.seesDomVisible(
	...
	verifyTheDatePickerFrequenciesInDrillDownViewForLaborPercentageOfIncome() {
	...
	verifyTheCancelButtonInTheDatePickerInDrillDownViewForLaborPercentageOfIncome() {
		this.seesDomVisible(
	...
	verifyTheApplyButtonInTheDatePickerInDrillDownViewForLaborPercentageOfIncome() {
		this.seesDomVisible(
...
export class RobotHands extends BaseHands {
	...
	clickOnDatePickerInDrillDownView() {
		this.wait(3000)
		this.clickOnDomElement('[aria-describedby="LABOR_PERCENTAGE_OF_INCOME"]')
	}
	...
	clicksOnAscendingOrderLaborPercentageOfIncomeButton() {
		this.clickOnDomElementWithIndex(
			'[class*="line-flex flex-col gap"] svg path',
			11
		)
	}
	clicksOnDescendingOrderLaborPercentageOfIncomeButton() {
		this.clickOnDomElementWithIndex(
			'[class*="line-flex flex-col gap"] svg path',
			10
		)
