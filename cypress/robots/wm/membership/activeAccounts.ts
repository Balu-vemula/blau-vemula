...
this.seesDomContainText('div[title="Active Members "] span[class="text-medium"]','No data available for selected range')
	...
	seesDatePickerIsVisibleOnDrillDownView(locator:string) {
		this.wait(3000)
		this.seesDomVisible(locator)
	}
	...
	seesGraphOnDrillDownView(locator:string) {
		this.wait(3000)
		this.seesIdVisible(locator)
    ...
    seesGraphOnTileView(locator:string) {
        this.seesDomVisible(locator)
    }
...
export class RobotHands extends BaseHands {
	...
	scrollingIntoTile(locater:string,index:number) {
		this.wait(10000)
	...
	clickOnDatePickerInDrillDownView(locator:string) {
		this.wait(3000)
